...
function insertScriptSrcInHtmlDom(e){var t=document.createElement("script");t.src=e;var n=document.querySelector("script");n.parentNode.insertBefore(t,n)}function importScriptsDependsOnBrowser(){"IE"===browser.name&&insertScriptSrcInHtmlDom("https://cdn.temasys.io/adapterjs/0.15.x/adapter.debug.js")}function noop(e){e&&logger.error(e)}function trackStop(e){e.stop&&e.stop()}function streamStop(e){e.getTracks().forEach(trackStop)}function bufferizeCandidates(e,t){var n=[],r=function(){if("stable"===e.signalingState)for(;n.length;){var t=n.shift();e.addIceCandidate(t.candidate,t.callback,t.callback)}};return function(e,t){"undefined"!=typeof AdapterJS&&"IE"===AdapterJS.webrtcDetectedBrowser&&AdapterJS.webrtcDetectedVersion>=9?t.onsignalingstatechange=e:t.addEventListener("signalingstatechange",e)}(r,e),function(r,i){switch(i=i||t,e.signalingState){case"closed":i(new Error("PeerConnection object is closed"));break;case"stable":if(e.remoteDescription){e.addIceCandidate(r,i,i);break}default:n.push({candidate:r,callback:i})}}}function removeFIDFromOffer(e){var t=e.indexOf("a=ssrc-group:FID");return t>0?e.slice(0,t):e}function getSimulcastInfo(e){var t=e.getVideoTracks();if(!t.length)return logger.warn("No video tracks available in the video stream"),"";var n=["a=x-google-flag:conference","a=ssrc-group:SIM 1 2 3","a=ssrc:1 cname:localVideo","a=ssrc:1 msid:"+e.id+" "+t[0].id,"a=ssrc:1 mslabel:"+e.id,"a=ssrc:1 label:"+t[0].id,"a=ssrc:2 cname:localVideo","a=ssrc:2 msid:"+e.id+" "+t[0].id,"a=ssrc:2 mslabel:"+e.id,"a=ssrc:2 label:"+t[0].id,"a=ssrc:3 cname:localVideo","a=ssrc:3 msid:"+e.id+" "+t[0].id,"a=ssrc:3 mslabel:"+e.id,"a=ssrc:3 label:"+t[0].id];return n.push(""),n.join("\n")}function sleep(e){for(var t=(new Date).getTime(),n=0;n<1e7&&!((new Date).getTime()-t>e);n++);}function setIceCandidateAccordingWebBrowser(e,t){"undefined"!=typeof AdapterJS&&"IE"===AdapterJS.webrtcDetectedBrowser&&AdapterJS.webrtcDetectedVersion>=9?t.onicecandidate=e:t.addEventListener("icecandidate",e)}function WebRtcPeer(e,t,n){function r(){if(s){s.pause();var e=b.getRemoteStreams()[0];s.srcObject=e,logger.debug("Remote stream:",e),"undefined"!=typeof AdapterJS&&"IE"===AdapterJS.webrtcDetectedBrowser&&AdapterJS.webrtcDetectedVersion>=9?s=attachMediaStream(s,e):s.load()}}function i(e){return y&&("Chrome"===browser.name||"Chromium"===browser.name?(logger.debug("Adding multicast info"),e=new RTCSessionDescription({type:e.type,sdp:removeFIDFromOffer(e.sdp)+getSimulcastInfo(l)})):logger.warn("Simulcast is only available in Chrome browser.")),e}function o(){"closed"===b.signalingState&&n('The peer connection object is in "closed" state. This is most likely due to an invocation of the dispose method before accepting in the dialogue'),l&&c&&(logger.debug("[debug] attach local videoStream ..."),d.showLocalVideo()),l&&(logger.debug("[debug] videoStream length: ",l.getTracks().length),l.getTracks().forEach(function(e){b.addTrack(e,l)})),u&&(logger.debug("[debug] audioStream length: ",u.getTracks().length),u.getTracks().forEach(function(e){b.addTrack(e,u)})),f&&(logger.debug("[debug] userAudioStream length: ",f.getTracks().length),f.getTracks().forEach(function(e){b.addTrack(e,f)})),n()}if(logger.debug("WebRtcPeer mode :"+e+"\n"),!(this instanceof WebRtcPeer))return new WebRtcPeer(e,t,n);WebRtcPeer.super_.call(this),t instanceof Function&&(n=t,t=void 0),t=t||{},n=(n||noop).bind(this);var a,d=this,c=t.localVideo,s=t.remoteVideo,l=t.videoStream,u=t.audioStream,g=t.isScreenShareAudio,f=t.userAudioStream,p=t.mediaConstraints,b=t.peerConnection,h=t.sendSource||"webcam",m=t.dataChannelConfig,v=t.dataChannels||!1,S=uuidv4(),w=recursive({iceServers:freeice()},t.configuration),P=t.onicecandidate;P&&this.on("icecandidate",P);var D=t.oncandidategatheringdone;D&&this.on("candidategatheringdone",D);var y=t.simulcast,R=t.multistream,A=new sdpTranslator.Interop,C=[],E=!1;if(Object.defineProperties(this,{peerConnection:{get:function(){return b}},id:{value:t.id||S,writable:!1},remoteVideo:{get:function(){return s}},localVideo:{get:function(){return c}},dataChannel:{get:function(){return a}},currentFrame:{get:function(){if(s){if(s.readyState<s.HAVE_CURRENT_DATA)throw new Error("No video stream data available");var e=document.createElement("canvas");return e.width=s.videoWidth,e.height=s.videoHeight,e.getContext("2d").drawImage(s,0,0),e}}}}),!b&&(b=new RTCPeerConnection(w),v&&!a)){var T="WebRtcPeer-"+d.id,W=void 0;m&&(T=m.id||T,W=m.options),a=b.createDataChannel(T,W),m&&(a.onopen=m.onopen,a.onclose=m.onclose,a.onmessage=m.onmessage,a.onbufferedamountlow=m.onbufferedamountlow,a.onerror=m.onerror||noop)}!b.getLocalStreams&&b.getSenders&&(b.getLocalStreams=function(){var e=new MediaStream;return b.getSenders().forEach(function(t){e.addTrack(t.track)}),[e]}),!b.getRemoteStreams&&b.getReceivers&&(b.getRemoteStreams=function(){var e=new MediaStream;return b.getReceivers().forEach(function(t){e.addTrack(t.track)}),[e]}),setIceCandidateAccordingWebBrowser(function(e){var t=e.candidate;if(EventEmitter.listenerCount(d,"icecandidate")||EventEmitter.listenerCount(d,"candidategatheringdone"))if(t){var n;n=R&&usePlanB?A.candidateToUnifiedPlan(t):t,"undefined"==typeof AdapterJS&&d.emit("icecandidate",n),E=!1}else E||("undefined"!=typeof AdapterJS&&"IE"===AdapterJS.webrtcDetectedBrowser&&AdapterJS.webrtcDetectedVersion>=9?EventEmitter.prototype.emit("candidategatheringdone",n):d.emit("candidategatheringdone"),E=!0);else E||(C.push(t),t||(E=!0))},b),b.onaddstream=t.onaddstream,b.onnegotiationneeded=t.onnegotiationneeded,this.on("newListener",function(e,t){if("icecandidate"===e||"candidategatheringdone"===e)for(;C.length;){var n=C.shift();!n==("candidategatheringdone"===e)&&t(n)}});var k=bufferizeCandidates(b);this.addIceCandidate=function(e,t){var n;n=R&&usePlanB?A.candidateToPlanB(e):new RTCIceCandidate(e),logger.debug("Remote ICE candidate received",e),t=(t||noop).bind(this),k(n,t)},this.generateOffer=function(t){if(t=t.bind(this),"recvonly"===e){var n=!p||"boolean"!=typeof p.audio||p.audio,r=!p||"boolean"!=typeof p.video||p.video;n&&b.addTransceiver("audio",{direction:"recvonly"}),r&&b.addTransceiver("video",{direction:"recvonly"})}else"sendonly"===e&&b.getTransceivers().forEach(function(e){e.direction="sendonly"});if("undefined"!=typeof AdapterJS&&"IE"===AdapterJS.webrtcDetectedBrowser&&AdapterJS.webrtcDetectedVersion>=9){var o=function(){sleep(1e3);var e=b.localDescription;logger.debug("Local description set\n",e.sdp),R&&usePlanB&&(e=A.toUnifiedPlan(e),logger.debug("offer::origPlanB->UnifiedPlan",dumpSDP(e))),t(null,e.sdp,d.processAnswer.bind(d))},a=function(e){logger.debug("Created SDP offer"),logger.debug("Local description set\n",b.localDescription),b.setLocalDescription(e,o,t)};b.createOffer(a,t)}else b.createOffer().then(function(e){return logger.debug("Created SDP offer"),e=i(e),b.setLocalDescription(e)}).then(function(){var e=b.localDescription;logger.debug("Local description set\n",e.sdp),R&&usePlanB&&(e=A.toUnifiedPlan(e),logger.debug("offer::origPlanB->UnifiedPlan",dumpSDP(e))),t(null,e.sdp,d.processAnswer.bind(d))}).catch(t)},this.getLocalSessionDescriptor=function(){return b.localDescription},this.getRemoteSessionDescriptor=function(){return b.remoteDescription},this.showLocalVideo=function(){c.srcObject=l,c.muted=!0,"undefined"!=typeof AdapterJS&&"IE"===AdapterJS.webrtcDetectedBrowser&&AdapterJS.webrtcDetectedVersion>=9&&(c=attachMediaStream(c,l))},this.send=function(e){a&&"open"===a.readyState?a.send(e):logger.warn("Trying to send data over a non-existing or closed data channel")},this.processAnswer=function(e,t){t=(t||noop).bind(this);var n=new RTCSessionDescription({type:"answer",sdp:e});if(R&&usePlanB){var i=A.toPlanB(n);logger.debug("asnwer::planB",dumpSDP(i)),n=i}if(logger.debug("SDP answer received, setting remote description"),"closed"===b.signalingState)return t("PeerConnection is closed");b.setRemoteDescription(n).then(function(){r(),t()},t)},this.processOffer=function(e,t){t=t.bind(this);var n=new RTCSessionDescription({type:"offer",sdp:e});if(R&&usePlanB){var o=A.toPlanB(n);logger.debug("offer::planB",dumpSDP(o)),n=o}if(logger.debug("SDP offer received, setting remote description"),"closed"===b.signalingState)return t("PeerConnection is closed");b.setRemoteDescription(n).then(function(){return r()}).then(function(){return b.createAnswer()}).then(function(e){return e=i(e),logger.debug("Created SDP answer"),b.setLocalDescription(e)}).then(function(){var e=b.localDescription;R&&usePlanB&&(e=A.toUnifiedPlan(e),logger.debug("answer::origPlanB->UnifiedPlan",dumpSDP(e))),logger.debug("Local description set\n",e.sdp),t(null,e.sdp)}).catch(t)},"recvonly"===e||l||u?(logger.debug("[debug][directly start streaming] got audio and video params."),setTimeout(o,0)):"webcam"===h?function(e){void 0===e&&(e=MEDIA_CONSTRAINTS),"undefined"!=typeof AdapterJS&&"IE"===AdapterJS.webrtcDetectedBrowser&&AdapterJS.webrtcDetectedVersion>=9?navigator.getUserMedia(e,function(e){l=e,o()},n):navigator.mediaDevices.getUserMedia(e).then(function(e){l=e,o()}).catch(n)}(p):function(e){void 0===e&&(e=MEDIA_CONSTRAINTS),logger.debug("[debug] AdapterJS",typeof AdapterJS),"undefined"!=typeof AdapterJS&&"IE"===AdapterJS.webrtcDetectedBrowser&&AdapterJS.webrtcDetectedVersion>=9?logger.debug("[debug][TODO][getScreenDisplay][undefined AdapterJS or IE webrtcDetectedVersion >= 9].."):(logger.debug("[debug][getScreenDisplay][calling getDisplayMedia api].."),g&&navigator.mediaDevices.getUserMedia({audio:!0}).then(function(e){logger.debug("[debug][getScreenDisplay][got user audio stream].."),f=e}).catch(n),navigator.mediaDevices.getDisplayMedia(e).then(function(e){l=e,logger.debug("[debug][getScreenDisplay][got user video stream].."),o()}).catch(n))}(p),this.on("_dispose",function(){c&&(c.pause(),c.srcObject=null,"undefined"==typeof AdapterJS&&c.load(),c.muted=!1),s&&(s.pause(),s.srcObject=null,"undefined"==typeof AdapterJS&&s.load()),d.removeAllListeners(),"undefined"!=typeof window&&void 0!==window.cancelChooseDesktopMedia&&window.cancelChooseDesktopMedia(S)})}function createEnableDescriptor(e){var t="get"+e+"Tracks";return{enumerable:!0,get:function(){if(this.peerConnection){var e=this.peerConnection.getLocalStreams();if(e.length){for(var n,r=0;n=e[r];r++)for(var i,o=n[t](),a=0;i=o[a];a++)if(!i.enabled)return!1;return!0}}},set:function(e){function n(t){t.enabled=e}this.peerConnection.getLocalStreams().forEach(function(e){e[t]().forEach(n)})}}}function WebRtcPeerRecvonly(e,t){if(!(this instanceof WebRtcPeerRecvonly))return new WebRtcPeerRecvonly(e,t);WebRtcPeerRecvonly.super_.call(this,"recvonly",e,t)}function WebRtcPeerSendonly(e,t){if(!(this instanceof WebRtcPeerSendonly))return new WebRtcPeerSendonly(e,t);WebRtcPeerSendonly.super_.call(this,"sendonly",e,t)}function WebRtcPeerSendrecv(e,t){if(!(this instanceof WebRtcPeerSendrecv))return new WebRtcPeerSendrecv(e,t);WebRtcPeerSendrecv.super_.call(this,"sendrecv",e,t)}function harkUtils(e,t){return hark(e,t)}var freeice=require("freeice"),inherits=require("inherits"),UAParser=require("ua-parser-js"),uuidv4=require("uuid/v4"),hark=require("hark"),EventEmitter=require("events").EventEmitter,recursive=require("merge").recursive.bind(void 0,!0),sdpTranslator=require("sdp-translator"),logger="undefined"==typeof window?console:window.Logger||console,MEDIA_CONSTRAINTS={audio:!0,video:{width:720,height:1280,framerate:60}},ua="undefined"!=typeof window&&window.navigator?window.navigator.userAgent:"",parser=new UAParser(ua),browser=parser.getBrowser();importScriptsDependsOnBrowser();var usePlanB=!1;"Chrome"!==browser.name&&"Chromium"!==browser.name||(logger.debug(browser.name+": using SDP PlanB"),usePlanB=!0);var dumpSDP=function(e){return void 0===e||null===e?"":"type: "+e.type+"\r\n"+e.sdp};inherits(WebRtcPeer,EventEmitter),Object.defineProperties(WebRtcPeer.prototype,{enabled:{enumerable:!0,get:function(){return this.audioEnabled&&this.videoEnabled},set:function(e){this.audioEnabled=this.videoEnabled=e}},audioEnabled:createEnableDescriptor("Audio"),videoEnabled:createEnableDescriptor("Video")}),WebRtcPeer.prototype.getLocalStream=function(e){if(this.peerConnection)return this.peerConnection.getLocalStreams()[e||0]},WebRtcPeer.prototype.getRemoteStream=function(e){if(this.peerConnection)return this.peerConnection.getRemoteStreams()[e||0]},WebRtcPeer.prototype.dispose=function(){logger.debug("Disposing WebRtcPeer");var e=this.peerConnection,t=this.dataChannel;try{if(t){if("closed"===t.readyState)return;t.close()}if(e){if("closed"===e.signalingState)return;e.getLocalStreams().forEach(streamStop),e.close()}}catch(e){logger.warn("Exception disposing webrtc peer "+e)}"undefined"==typeof AdapterJS&&this.emit("_dispose")},inherits(WebRtcPeerRecvonly,WebRtcPeer),inherits(WebRtcPeerSendonly,WebRtcPeer),inherits(WebRtcPeerSendrecv,WebRtcPeer),exports.bufferizeCandidates=bufferizeCandidates,exports.WebRtcPeerRecvonly=WebRtcPeerRecvonly,exports.WebRtcPeerSendonly=WebRtcPeerSendonly,exports.WebRtcPeerSendrecv=WebRtcPeerSendrecv,exports.hark=harkUtils;
...
!function(i,s){"use strict";var e="model",o="name",r="type",a="vendor",t="version",n="mobile",d="tablet",l="smarttv",w={extend:function(i,s){var e={};for(var o in i)s[o]&&s[o].length%2==0?e[o]=s[o].concat(i[o]):e[o]=i[o];return e},has:function(i,s){return"string"==typeof i&&-1!==s.toLowerCase().indexOf(i.toLowerCase())},lowerize:function(i){return i.toLowerCase()},major:function(i){return"string"==typeof i?i.replace(/[^\d\.]/g,"").split(".")[0]:void 0},trim:function(i,s){return i=i.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,""),void 0===s?i:i.substring(0,255)}},b={rgx:function(i,s){for(var e,o,r,a,t,n,d=0;d<s.length&&!t;){var l=s[d],w=s[d+1];for(e=o=0;e<l.length&&!t;)if(t=l[e++].exec(i))for(r=0;r<w.length;r++)n=t[++o],a=w[r],"object"==typeof a&&a.length>0?2==a.length?"function"==typeof a[1]?this[a[0]]=a[1].call(this,n):this[a[0]]=a[1]:3==a.length?"function"!=typeof a[1]||a[1].exec&&a[1].test?this[a[0]]=n?n.replace(a[1],a[2]):void 0:this[a[0]]=n?a[1].call(this,n,a[2]):void 0:4==a.length&&(this[a[0]]=n?a[3].call(this,n.replace(a[1],a[2])):void 0):this[a]=n||void 0;d+=2}},str:function(i,s){for(var e in s)if("object"==typeof s[e]&&s[e].length>0){for(var o=0;o<s[e].length;o++)if(w.has(s[e][o],i))return"?"===e?void 0:e}else if(w.has(s[e],i))return"?"===e?void 0:e;return i}},u={browser:{oldSafari:{version:{"1.0":"/8",1.2:"/1",1.3:"/3","2.0":"/412","2.0.2":"/416","2.0.3":"/417","2.0.4":"/419","?":"/"}},oldEdge:{version:{.1:"12.",21:"13.",31:"14.",39:"15.",41:"16.",42:"17.",44:"18."}}},os:{windows:{version:{ME:"4.90","NT 3.11":"NT3.51","NT 4.0":"NT4.0",2000:"NT 5.0",XP:["NT 5.1","NT 5.2"],Vista:"NT 6.0",7:"NT 6.1",8:"NT 6.2",8.1:"NT 6.3",10:["NT 6.4","NT 10.0"],RT:"ARM"}}}},c={browser:[[/\b(?:crmo|crios)\/([\w\.]+)/i],[t,[o,"Chrome"]],[/edg(?:e|ios|a)?\/([\w\.]+)/i],[t,[o,"Edge"]],[/(opera\smini)\/([\w\.-]+)/i,/(opera\s[mobiletab]{3,6})\b.+version\/([\w\.-]+)/i,/(opera)(?:.+version\/|[\/\s]+)([\w\.]+)/i],[o,t],[/opios[\/\s]+([\w\.]+)/i],[t,[o,"Opera Mini"]],[/\sopr\/([\w\.]+)/i],[t,[o,"Opera"]],[/(kindle)\/([\w\.]+)/i,/(lunascape|maxthon|netfront|jasmine|blazer)[\/\s]?([\w\.]*)/i,/(avant\s|iemobile|slim)(?:browser)?[\/\s]?([\w\.]*)/i,/(ba?idubrowser)[\/\s]?([\w\.]+)/i,/(?:ms|\()(ie)\s([\w\.]+)/i,/(flock|rockmelt|midori|epiphany|silk|skyfire|ovibrowser|bolt|iron|vivaldi|iridium|phantomjs|bowser|quark|qupzilla|falkon)\/([\w\.-]+)/i,/(rekonq|puffin|brave|whale|qqbrowserlite|qq)\/([\w\.]+)/i,/(weibo)__([\d\.]+)/i],[o,t],[/(?:[\s\/]uc?\s?browser|(?:juc.+)ucweb)[\/\s]?([\w\.]+)/i],[t,[o,"UCBrowser"]],[/(?:windowswechat)?\sqbcore\/([\w\.]+)\b.*(?:windowswechat)?/i],[t,[o,"WeChat(Win) Desktop"]],[/micromessenger\/([\w\.]+)/i],[t,[o,"WeChat"]],[/konqueror\/([\w\.]+)/i],[t,[o,"Konqueror"]],[/trident.+rv[:\s]([\w\.]{1,9})\b.+like\sgecko/i],[t,[o,"IE"]],[/yabrowser\/([\w\.]+)/i],[t,[o,"Yandex"]],[/(avast|avg)\/([\w\.]+)/i],[[o,/(.+)/,"$1 Secure Browser"],t],[/focus\/([\w\.]+)/i],[t,[o,"Firefox Focus"]],[/opt\/([\w\.]+)/i],[t,[o,"Opera Touch"]],[/coc_coc_browser\/([\w\.]+)/i],[t,[o,"Coc Coc"]],[/dolfin\/([\w\.]+)/i],[t,[o,"Dolphin"]],[/coast\/([\w\.]+)/i],[t,[o,"Opera Coast"]],[/xiaomi\/miuibrowser\/([\w\.]+)/i],[t,[o,"MIUI Browser"]],[/fxios\/([\w\.-]+)/i],[t,[o,"Firefox"]],[/(qihu|qhbrowser|qihoobrowser|360browser)/i],[[o,"360 Browser"]],[/(oculus|samsung|sailfish)browser\/([\w\.]+)/i],[[o,/(.+)/,"$1 Browser"],t],[/(comodo_dragon)\/([\w\.]+)/i],[[o,/_/g," "],t],[/\s(electron)\/([\w\.]+)\ssafari/i,/(tesla)(?:\sqtcarbrowser|\/(20[12]\d\.[\w\.-]+))/i,/m?(qqbrowser|baiduboxapp|2345Explorer)[\/\s]?([\w\.]+)/i],[o,t],[/(MetaSr)[\/\s]?([\w\.]+)/i,/(LBBROWSER)/i],[o],[/;fbav\/([\w\.]+);/i],[t,[o,"Facebook"]],[/FBAN\/FBIOS|FB_IAB\/FB4A/i],[[o,"Facebook"]],[/safari\s(line)\/([\w\.]+)/i,/\b(line)\/([\w\.]+)\/iab/i,/(chromium|instagram)[\/\s]([\w\.-]+)/i],[o,t],[/\bgsa\/([\w\.]+)\s.*safari\//i],[t,[o,"GSA"]],[/headlesschrome(?:\/([\w\.]+)|\s)/i],[t,[o,"Chrome Headless"]],[/\swv\).+(chrome)\/([\w\.]+)/i],[[o,"Chrome WebView"],t],[/droid.+\sversion\/([\w\.]+)\b.+(?:mobile\ssafari|safari)/i],[t,[o,"Android Browser"]],[/(chrome|omniweb|arora|[tizenoka]{5}\s?browser)\/v?([\w\.]+)/i],[o,t],[/version\/([\w\.]+)\s.*mobile\/\w+\s(safari)/i],[t,[o,"Mobile Safari"]],[/version\/([\w\.]+)\s.*(mobile\s?safari|safari)/i],[t,o],[/webkit.+?(mobile\s?safari|safari)(\/[\w\.]+)/i],[o,[t,b.str,u.browser.oldSafari.version]],[/(webkit|khtml)\/([\w\.]+)/i],[o,t],[/(navigator|netscape)\/([\w\.-]+)/i],[[o,"Netscape"],t],[/ile\svr;\srv:([\w\.]+)\).+firefox/i],[t,[o,"Firefox Reality"]],[/ekiohf.+(flow)\/([\w\.]+)/i,/(swiftfox)/i,/(icedragon|iceweasel|camino|chimera|fennec|maemo\sbrowser|minimo|conkeror)[\/\s]?([\w\.\+]+)/i,/(firefox|seamonkey|k-meleon|icecat|iceape|firebird|phoenix|palemoon|basilisk|waterfox)\/([\w\.-]+)$/i,/(firefox)\/([\w\.]+)\s[\w\s\-]+\/[\w\.]+$/i,/(mozilla)\/([\w\.]+)\s.+rv\:.+gecko\/\d+/i,/(polaris|lynx|dillo|icab|doris|amaya|w3m|netsurf|sleipnir)[\/\s]?([\w\.]+)/i,/(links)\s\(([\w\.]+)/i,/(gobrowser)\/?([\w\.]*)/i,/(ice\s?browser)\/v?([\w\._]+)/i,/(mosaic)[\/\s]([\w\.]+)/i],[o,t]],cpu:[[/(?:(amd|x(?:(?:86|64)[_-])?|wow|win)64)[;\)]/i],[["architecture","amd64"]],[/(ia32(?=;))/i],[["architecture",w.lowerize]],[/((?:i[346]|x)86)[;\)]/i],[["architecture","ia32"]],[/\b(aarch64|armv?8e?l?)\b/i],[["architecture","arm64"]],[/\b(arm(?:v[67])?ht?n?[fl]p?)\b/i],[["architecture","armhf"]],[/windows\s(ce|mobile);\sppc;/i],[["architecture","arm"]],[/((?:ppc|powerpc)(?:64)?)(?:\smac|;|\))/i],[["architecture",/ower/,"",w.lowerize]],[/(sun4\w)[;\)]/i],[["architecture","sparc"]],[/((?:avr32|ia64(?=;))|68k(?=\))|\barm(?:64|(?=v(?:[1-7]|[5-7]1)l?|;|eabi))|(?=atmel\s)avr|(?:irix|mips|sparc)(?:64)?\b|pa-risc)/i],[["architecture",w.lowerize]]],device:[[/\b(sch-i[89]0\d|shw-m380s|sm-[pt]\w{2,4}|gt-[pn]\d{2,4}|sgh-t8[56]9|nexus\s10)/i],[e,[a,"Samsung"],[r,d]],[/\b((?:s[cgp]h|gt|sm)-\w+|galaxy\snexus)/i,/\ssamsung[\s-]([\w-]+)/i,/sec-(sgh\w+)/i],[e,[a,"Samsung"],[r,n]],[/\((ip(?:hone|od)[\s\w]*);/i],[e,[a,"Apple"],[r,n]],[/\((ipad);[\w\s\),;-]+apple/i,/applecoremedia\/[\w\.]+\s\((ipad)/i,/\b(ipad)\d\d?,\d\d?[;\]].+ios/i],[e,[a,"Apple"],[r,d]],[/\b((?:agr|ags[23]|bah2?|sht?)-a?[lw]\d{2})/i],[e,[a,"Huawei"],[r,d]],[/d\/huawei([\w\s-]+)[;\)]/i,/\b(nexus\s6p|vog-[at]?l\d\d|ane-[at]?l[x\d]\d|eml-a?l\d\da?|lya-[at]?l\d[\dc]|clt-a?l\d\di?|ele-l\d\d)/i,/\b(\w{2,4}-[atu][ln][01259][019])[;\)\s]/i],[e,[a,"Huawei"],[r,n]],[/\b(poco[\s\w]+)(?:\sbuild|\))/i,/\b;\s(\w+)\sbuild\/hm\1/i,/\b(hm[\s\-_]?note?[\s_]?(?:\d\w)?)\sbuild/i,/\b(redmi[\s\-_]?(?:note|k)?[\w\s_]+)(?:\sbuild|\))/i,/\b(mi[\s\-_]?(?:a\d|one|one[\s_]plus|note lte)?[\s_]?(?:\d?\w?)[\s_]?(?:plus)?)\sbuild/i],[[e,/_/g," "],[a,"Xiaomi"],[r,n]],[/\b(mi[\s\-_]?(?:pad)(?:[\w\s_]+))(?:\sbuild|\))/i],[[e,/_/g," "],[a,"Xiaomi"],[r,d]],[/;\s(\w+)\sbuild.+\soppo/i,/\s(cph[12]\d{3}|p(?:af|c[al]|d\w|e[ar])[mt]\d0|x9007)\b/i],[e,[a,"OPPO"],[r,n]],[/\svivo\s(\w+)(?:\sbuild|\))/i,/\s(v[12]\d{3}\w?[at])(?:\sbuild|;)/i],[e,[a,"Vivo"],[r,n]],[/\s(rmx[12]\d{3})(?:\sbuild|;)/i],[e,[a,"Realme"],[r,n]],[/\s(milestone|droid(?:[2-4x]|\s(?:bionic|x2|pro|razr))?:?(\s4g)?)\b[\w\s]+build\//i,/\smot(?:orola)?[\s-](\w*)/i,/((?:moto[\s\w\(\)]+|xt\d{3,4}|nexus\s6)(?=\sbuild|\)))/i],[e,[a,"Motorola"],[r,n]],[/\s(mz60\d|xoom[\s2]{0,2})\sbuild\//i],[e,[a,"Motorola"],[r,d]],[/((?=lg)?[vl]k\-?\d{3})\sbuild|\s3\.[\s\w;-]{10}lg?-([06cv9]{3,4})/i],[e,[a,"LG"],[r,d]],[/(lm-?f100[nv]?|nexus\s[45])/i,/lg[e;\s\/-]+((?!browser|netcast)\w+)/i,/\blg(\-?[\d\w]+)\sbuild/i],[e,[a,"LG"],[r,n]],[/(ideatab[\w\-\s]+)/i,/lenovo\s?(s(?:5000|6000)(?:[\w-]+)|tab(?:[\s\w]+)|yt[\d\w-]{6}|tb[\d\w-]{6})/i],[e,[a,"Lenovo"],[r,d]],[/(?:maemo|nokia).*(n900|lumia\s\d+)/i,/nokia[\s_-]?([\w\.-]*)/i],[[e,/_/g," "],[a,"Nokia"],[r,n]],[/droid.+;\s(pixel\sc)[\s)]/i],[e,[a,"Google"],[r,d]],[/droid.+;\s(pixel[\s\daxl]{0,6})(?:\sbuild|\))/i],[e,[a,"Google"],[r,n]],[/droid.+\s([c-g]\d{4}|so[-l]\w+|xq-a\w[4-7][12])(?=\sbuild\/|\).+chrome\/(?![1-6]{0,1}\d\.))/i],[e,[a,"Sony"],[r,n]],[/sony\stablet\s[ps]\sbuild\//i,/(?:sony)?sgp\w+(?:\sbuild\/|\))/i],[[e,"Xperia Tablet"],[a,"Sony"],[r,d]],[/\s(kb2005|in20[12]5|be20[12][59])\b/i,/\ba000(1)\sbuild/i,/\boneplus\s(a\d{4})[\s)]/i],[e,[a,"OnePlus"],[r,n]],[/(alexa)webm/i,/(kf[a-z]{2}wi)(\sbuild\/|\))/i,/(kf[a-z]+)(\sbuild\/|\)).+silk\//i],[e,[a,"Amazon"],[r,d]],[/(sd|kf)[0349hijorstuw]+(\sbuild\/|\)).+silk\//i],[[e,"Fire Phone"],[a,"Amazon"],[r,n]],[/\((playbook);[\w\s\),;-]+(rim)/i],[e,a,[r,d]],[/((?:bb[a-f]|st[hv])100-\d)/i,/\(bb10;\s(\w+)/i],[e,[a,"BlackBerry"],[r,n]],[/(?:\b|asus_)(transfo[prime\s]{4,10}\s\w+|eeepc|slider\s\w+|nexus\s7|padfone|p00[cj])/i],[e,[a,"ASUS"],[r,d]],[/\s(z[es]6[027][01][km][ls]|zenfone\s\d\w?)\b/i],[e,[a,"ASUS"],[r,n]],[/(nexus\s9)/i],[e,[a,"HTC"],[r,d]],[/(htc)[;_\s-]{1,2}([\w\s]+(?=\)|\sbuild)|\w+)/i,/(zte)-(\w*)/i,/(alcatel|geeksphone|nexian|panasonic|(?=;\s)sony)[_\s-]?([\w-]*)/i],[a,[e,/_/g," "],[r,n]],[/droid[x\d\.\s;]+\s([ab][1-7]\-?[0178a]\d\d?)/i],[e,[a,"Acer"],[r,d]],[/droid.+;\s(m[1-5]\snote)\sbuild/i,/\bmz-([\w-]{2,})/i],[e,[a,"Meizu"],[r,n]],[/(blackberry|benq|palm(?=\-)|sonyericsson|acer|asus|dell|meizu|motorola|polytron)[\s_-]?([\w-]*)/i,/(hp)\s([\w\s]+\w)/i,/(asus)-?(\w+)/i,/(microsoft);\s(lumia[\s\w]+)/i,/(lenovo)[_\s-]?([\w-]+)/i,/linux;.+(jolla);/i,/droid.+;\s(oppo)\s?([\w\s]+)\sbuild/i],[a,e,[r,n]],[/(archos)\s(gamepad2?)/i,/(hp).+(touchpad(?!.+tablet)|tablet)/i,/(kindle)\/([\w\.]+)/i,/\s(nook)[\w\s]+build\/(\w+)/i,/(dell)\s(strea[kpr\s\d]*[\dko])/i,/[;\/]\s?(le[\s\-]+pan)[\s\-]+(\w{1,9})\sbuild/i,/[;\/]\s?(trinity)[\-\s]*(t\d{3})\sbuild/i,/\b(gigaset)[\s\-]+(q\w{1,9})\sbuild/i,/\b(vodafone)\s([\w\s]+)(?:\)|\sbuild)/i],[a,e,[r,d]],[/\s(surface\sduo)\s/i],[e,[a,"Microsoft"],[r,d]],[/droid\s[\d\.]+;\s(fp\du?)\sbuild/i],[e,[a,"Fairphone"],[r,n]],[/\s(u304aa)\sbuild/i],[e,[a,"AT&T"],[r,n]],[/sie-(\w*)/i],[e,[a,"Siemens"],[r,n]],[/[;\/]\s?(rct\w+)\sbuild/i],[e,[a,"RCA"],[r,d]],[/[;\/\s](venue[\d\s]{2,7})\sbuild/i],[e,[a,"Dell"],[r,d]],[/[;\/]\s?(q(?:mv|ta)\w+)\sbuild/i],[e,[a,"Verizon"],[r,d]],[/[;\/]\s(?:barnes[&\s]+noble\s|bn[rt])([\w\s\+]*)\sbuild/i],[e,[a,"Barnes & Noble"],[r,d]],[/[;\/]\s(tm\d{3}\w+)\sbuild/i],[e,[a,"NuVision"],[r,d]],[/;\s(k88)\sbuild/i],[e,[a,"ZTE"],[r,d]],[/;\s(nx\d{3}j)\sbuild/i],[e,[a,"ZTE"],[r,n]],[/[;\/]\s?(gen\d{3})\sbuild.*49h/i],[e,[a,"Swiss"],[r,n]],[/[;\/]\s?(zur\d{3})\sbuild/i],[e,[a,"Swiss"],[r,d]],[/[;\/]\s?((zeki)?tb.*\b)\sbuild/i],[e,[a,"Zeki"],[r,d]],[/[;\/]\s([yr]\d{2})\sbuild/i,/[;\/]\s(dragon[\-\s]+touch\s|dt)(\w{5})\sbuild/i],[[a,"Dragon Touch"],e,[r,d]],[/[;\/]\s?(ns-?\w{0,9})\sbuild/i],[e,[a,"Insignia"],[r,d]],[/[;\/]\s?((nxa|Next)-?\w{0,9})\sbuild/i],[e,[a,"NextBook"],[r,d]],[/[;\/]\s?(xtreme\_)?(v(1[045]|2[015]|[3469]0|7[05]))\sbuild/i],[[a,"Voice"],e,[r,n]],[/[;\/]\s?(lvtel\-)?(v1[12])\sbuild/i],[[a,"LvTel"],e,[r,n]],[/;\s(ph-1)\s/i],[e,[a,"Essential"],[r,n]],[/[;\/]\s?(v(100md|700na|7011|917g).*\b)\sbuild/i],[e,[a,"Envizen"],[r,d]],[/[;\/]\s?(trio[\s\w\-\.]+)\sbuild/i],[e,[a,"MachSpeed"],[r,d]],[/[;\/]\s?tu_(1491)\sbuild/i],[e,[a,"Rotor"],[r,d]],[/(shield[\w\s]+)\sbuild/i],[e,[a,"Nvidia"],[r,d]],[/(sprint)\s(\w+)/i],[a,e,[r,n]],[/(kin\.[onetw]{3})/i],[[e,/\./g," "],[a,"Microsoft"],[r,n]],[/droid\s[\d\.]+;\s(cc6666?|et5[16]|mc[239][23]x?|vc8[03]x?)\)/i],[e,[a,"Zebra"],[r,d]],[/droid\s[\d\.]+;\s(ec30|ps20|tc[2-8]\d[kx])\)/i],[e,[a,"Zebra"],[r,n]],[/\s(ouya)\s/i,/(nintendo)\s([wids3utch]+)/i],[a,e,[r,"console"]],[/droid.+;\s(shield)\sbuild/i],[e,[a,"Nvidia"],[r,"console"]],[/(playstation\s[345portablevi]+)/i],[e,[a,"Sony"],[r,"console"]],[/[\s\(;](xbox(?:\sone)?(?!;\sxbox))[\s\);]/i],[e,[a,"Microsoft"],[r,"console"]],[/smart-tv.+(samsung)/i],[a,[r,l]],[/hbbtv.+maple;(\d+)/i],[[e,/^/,"SmartTV"],[a,"Samsung"],[r,l]],[/(?:linux;\snetcast.+smarttv|lg\snetcast\.tv-201\d)/i],[[a,"LG"],[r,l]],[/(apple)\s?tv/i],[a,[e,"Apple TV"],[r,l]],[/crkey/i],[[e,"Chromecast"],[a,"Google"],[r,l]],[/droid.+aft([\w])(\sbuild\/|\))/i],[e,[a,"Amazon"],[r,l]],[/\(dtv[\);].+(aquos)/i],[e,[a,"Sharp"],[r,l]],[/hbbtv\/\d+\.\d+\.\d+\s+\([\w\s]*;\s*(\w[^;]*);([^;]*)/i],[[a,w.trim],[e,w.trim],[r,l]],[/[\s\/\(](android\s|smart[-\s]?|opera\s)tv[;\)\s]/i],[[r,l]],[/((pebble))app\/[\d\.]+\s/i],[a,e,[r,"wearable"]],[/droid.+;\s(glass)\s\d/i],[e,[a,"Google"],[r,"wearable"]],[/droid\s[\d\.]+;\s(wt63?0{2,3})\)/i],[e,[a,"Zebra"],[r,"wearable"]],[/(tesla)(?:\sqtcarbrowser|\/20[12]\d\.[\w\.-]+)/i],[a,[r,"embedded"]],[/droid .+?; ([^;]+?)(?: build|\) applewebkit).+? mobile safari/i],[e,[r,n]],[/droid .+?;\s([^;]+?)(?: build|\) applewebkit).+?(?! mobile) safari/i],[e,[r,d]],[/\s(tablet|tab)[;\/]/i,/\s(mobile)(?:[;\/]|\ssafari)/i],[[r,w.lowerize]],[/(android[\w\.\s\-]{0,9});.+build/i],[e,[a,"Generic"]],[/(phone)/i],[[r,n]]],engine:[[/windows.+\sedge\/([\w\.]+)/i],[t,[o,"EdgeHTML"]],[/webkit\/537\.36.+chrome\/(?!27)([\w\.]+)/i],[t,[o,"Blink"]],[/(presto)\/([\w\.]+)/i,/(webkit|trident|netfront|netsurf|amaya|lynx|w3m|goanna)\/([\w\.]+)/i,/ekioh(flow)\/([\w\.]+)/i,/(khtml|tasman|links)[\/\s]\(?([\w\.]+)/i,/(icab)[\/\s]([23]\.[\d\.]+)/i],[o,t],[/rv\:([\w\.]{1,9})\b.+(gecko)/i],[t,o]],os:[[/microsoft\s(windows)\s(vista|xp)/i],[o,t],[/(windows)\snt\s6\.2;\s(arm)/i,/(windows\sphone(?:\sos)*)[\s\/]?([\d\.\s\w]*)/i,/(windows\smobile|windows)[\s\/]?([ntce\d\.\s]+\w)(?!.+xbox)/i],[o,[t,b.str,u.os.windows.version]],[/(win(?=3|9|n)|win\s9x\s)([nt\d\.]+)/i],[[o,"Windows"],[t,b.str,u.os.windows.version]],[/ip[honead]{2,4}\b(?:.*os\s([\w]+)\slike\smac|;\sopera)/i,/cfnetwork\/.+darwin/i],[[t,/_/g,"."],[o,"iOS"]],[/(mac\sos\sx)\s?([\w\s\.]*)/i,/(macintosh|mac(?=_powerpc)\s)(?!.+haiku)/i],[[o,"Mac OS"],[t,/_/g,"."]],[/(android|webos|palm\sos|qnx|bada|rim\stablet\sos|meego|sailfish|contiki)[\/\s-]?([\w\.]*)/i,/(blackberry)\w*\/([\w\.]*)/i,/(tizen|kaios)[\/\s]([\w\.]+)/i,/\((series40);/i],[o,t],[/\(bb(10);/i],[t,[o,"BlackBerry"]],[/(?:symbian\s?os|symbos|s60(?=;)|series60)[\/\s-]?([\w\.]*)/i],[t,[o,"Symbian"]],[/mozilla.+\(mobile;.+gecko.+firefox/i],[[o,"Firefox OS"]],[/web0s;.+rt(tv)/i,/\b(?:hp)?wos(?:browser)?\/([\w\.]+)/i],[t,[o,"webOS"]],[/crkey\/([\d\.]+)/i],[t,[o,"Chromecast"]],[/(cros)\s[\w]+\s([\w\.]+\w)/i],[[o,"Chromium OS"],t],[/(nintendo|playstation)\s([wids345portablevuch]+)/i,/(xbox);\s+xbox\s([^\);]+)/i,/(mint)[\/\s\(\)]?(\w*)/i,/(mageia|vectorlinux)[;\s]/i,/(joli|[kxln]?ubuntu|debian|suse|opensuse|gentoo|arch(?=\slinux)|slackware|fedora|mandriva|centos|pclinuxos|redhat|zenwalk|linpus|raspbian)(?:\sgnu\/linux)?(?:\slinux)?[\/\s-]?(?!chrom|package)([\w\.-]*)/i,/(hurd|linux)\s?([\w\.]*)/i,/(gnu)\s?([\w\.]*)/i,/\s([frentopc-]{0,4}bsd|dragonfly)\s?(?!amd|[ix346]{1,2}86)([\w\.]*)/i,/(haiku)\s(\w+)/i],[o,t],[/(sunos)\s?([\w\.\d]*)/i],[[o,"Solaris"],t],[/((?:open)?solaris)[\/\s-]?([\w\.]*)/i,/(aix)\s((\d)(?=\.|\)|\s)[\w\.])*/i,/(plan\s9|minix|beos|os\/2|amigaos|morphos|risc\sos|openvms|fuchsia)/i,/(unix)\s?([\w\.]*)/i],[o,t]]},m=function(s,e){if("object"==typeof s&&(e=s,s=void 0),!(this instanceof m))return new m(s,e).getResult();var o=s||(void 0!==i&&i.navigator&&i.navigator.userAgent?i.navigator.userAgent:""),r=e?w.extend(c,e):c;return this.getBrowser=function(){var i={name:void 0,version:void 0};return b.rgx.call(i,o,r.browser),i.major=w.major(i.version),i},this.getCPU=function(){var i={architecture:void 0};return b.rgx.call(i,o,r.cpu),i},this.getDevice=function(){var i={vendor:void 0,model:void 0,type:void 0};return b.rgx.call(i,o,r.device),i},this.getEngine=function(){var i={name:void 0,version:void 0};return b.rgx.call(i,o,r.engine),i},this.getOS=function(){var i={name:void 0,version:void 0};return b.rgx.call(i,o,r.os),i},this.getResult=function(){return{ua:this.getUA(),browser:this.getBrowser(),engine:this.getEngine(),os:this.getOS(),device:this.getDevice(),cpu:this.getCPU()}},this.getUA=function(){return o},this.setUA=function(i){return o="string"==typeof i&&i.length>255?w.trim(i,255):i,this},this.setUA(o),this};m.VERSION="0.7.28",m.BROWSER={NAME:o,MAJOR:"major",VERSION:t},m.CPU={ARCHITECTURE:"architecture"},m.DEVICE={MODEL:e,VENDOR:a,TYPE:r,CONSOLE:"console",MOBILE:n,SMARTTV:l,TABLET:d,WEARABLE:"wearable",EMBEDDED:"embedded"},m.ENGINE={NAME:o,VERSION:t},m.OS={NAME:o,VERSION:t},"undefined"!=typeof exports?("undefined"!=typeof module&&module.exports&&(exports=module.exports=m),exports.UAParser=m):"function"==typeof define&&define.amd?define(function(){return m}):void 0!==i&&(i.UAParser=m);var p=void 0!==i&&(i.jQuery||i.Zepto);if(p&&!p.ua){var h=new m;p.ua=h.getResult(),p.ua.get=function(){return h.getUA()},p.ua.set=function(i){h.setUA(i);var s=h.getResult();for(var e in s)p.ua[e]=s[e]}}}("object"==typeof window?window:this);
...
//# sourceMappingURL=kurento-utils-share.map